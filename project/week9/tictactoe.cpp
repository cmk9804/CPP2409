...
bool isVaild(int x, int y, char board[numCell][numCell]); 
bool checkWin( char board[numCell][numCell], char currentUser, bool isWin);
...
int main() {
	...
	while (true) {
		...
		*/
		...
		isWin = checkWin( board, currentUser, isWin);
		/*
